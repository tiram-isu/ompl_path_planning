...
class PathPlanner:
    def __init__(self, mesh, camera_bounds, planner_type, range=0.1, state_validity_resolution=0.001, bounds_padding=0.01):
        ...
        # Set camera bounds for collision checking
        ...
        self.validity_checker = StateValidityChecker(self.si, self.mesh, self.camera_bounds)
    ...
    def setup_bounds(self):
        ...
        # TODO: replace by checking ground
