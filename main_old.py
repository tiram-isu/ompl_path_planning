...
from planner_old import PathPlanner
...
def run_planners(model, planners, planner_settings, path_settings, enable_visualization):
    ...
    visualizer = Visualizer(model['voxel_grid'], enable_visualization, camera_radius)
...
if __name__ == "__main__":
    ...
    path_settings = {"num_paths": num_paths, "start": start, "goal": goal, "camera_radius": camera_radius, "max_time_per_path": max_time_per_path}
