...
class PathPlanner:
    def __init__(self, voxel_grid, camera_radius, planner_type, range=0.1, state_validity_resolution=0.001, bounds_padding=0.1):
        ...
        # vertices = np.asarray(self.voxel_grid.vertices)
        ...
        self.validity_checker = StateValidityChecker(self.si, self.voxel_grid, self.camera_radius)
    ...
    def setup_bounds(self):
        ...
        min_bounds = (0, 0, 0)
        max_bounds = self.voxel_grid.calculate_grid_dimensions()
