...
def display_gaussians_as_ellipsoids(gaussian_data, output_file="ellipsoids.obj"):
...
display_gaussians_as_ellipsoids(gaussian_data, output_file="/app/gs_test/stonehenge.obj")
